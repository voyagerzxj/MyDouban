---
title: 📚 我的书影音标记站
description: 电影 / 书 / 日本动画 / 纪录片 / YouTube 视频的个人标记中心
published: true
...
这里是我的个人「豆瓣」：所有想看 / 在看 / 已看的内容都在这里标记。
每个页面都是一个 Markdown 文件，自动双向同步到 [GitHub 仓库](https://github.com/voyagerzxj/MyDouban)。
...
- 网页右上角「+ 新建页面」，**路径用英文**（如 `music/albums`），**标题用中文**；
- 或者直接在 GitHub 仓库 / 本地 clone 里新建 md 文件，几分钟内会自动同步进来；
- 新条目格式可以抄 [📋 条目模板](/templates/item)。
